...
// @has '-' '//*[@class="item-left module-item"]//*[@class="stab portability"]/@title' 'Available with crate feature `sync` only'
...
// @has '-' '//*[@class="stab portability"]' 'Available with crate feature sync only.'
#[doc(cfg(feature = "sync"))]
pub mod bar {
